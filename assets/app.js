...
import { buildAlipayTransactionUpdates as buildAlipayTransactionUpdatesForState } from "./alipay-reconciliation.mjs";
import {
...
function buildAlipayTransactionUpdates(reconciliationItems, categoryHistory) {
  return buildAlipayTransactionUpdatesForState({
    reconciliationItems,
    transactions: state.transactions,
    accounts: state.accounts,
    categoryHistory,
    createPreviewId: createId,
  });
}
